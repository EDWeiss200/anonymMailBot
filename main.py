...
BOT_NAME = input('Введите имя :')
bot_username = input("Введите username бота:")
...
def handle_start(message):
    ...
    # Если кода нет, показываем персональную ссылку
        ...
        bot.send_message(user_id, f"Привет👋, я бот {BOT_NAME} для отправки анонимных сообщений.Вот твоя персональная ссылка для получения анонимных сообщений: "
                                  f"https://t.me/{bot_username}?start={unique_code}")
